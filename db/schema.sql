...
-- optional JSON features (amenities, utilities, rules summary, etc.)
...
CREATE TABLE reviews (
  ...
  -- prevent duplicate reviews per target from same user in same contract
